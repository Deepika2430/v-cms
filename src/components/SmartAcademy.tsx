  ...
  return (
    <section className="py-16 px-17 md:px-14 bg-white font-[Poppins,sans-serif]">
      <div className="max-w-7xl mx-auto text-center">
        <h1 className="text-3xl md:text-4xl font-semibold text-gray-800">Welcome to the</h1>
        <h2 className="text-4xl md:text-5xl font-[Poppins,sans-serif] text-[#006D9B] mt-2 tracking-tight">SMART ACADEMY</h2>

        <div className="mt-9 max-w-5xl mx-auto text-gray-600 text-lg leading-relaxed">
          <p>
            We encourage educators to embrace innovation and adapt their teaching methods to the needs of today’s students, providing
            them with the tools and experiences necessary to succeed in the future. Also we emphasize on forward-thinking, creativity,
            and a commitment to preparing students for a rapidly evolving world.
          </p>
        </div>
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          >
              ...
              <img src={img} alt={alt} className="w-24 h-24 mb-4" />
