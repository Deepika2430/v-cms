...
const Footer: React.FC = () => {
  return (
    <footer className="w-full bg-[#F2F7FD]">
          ...
          <div className="container mx-auto flex flex-col md:flex-row items-start">
            ...
            <div className="mb-[20px]">
              ...
              <p className="text-gray-800 mb-[14px] text-[16px] font-poppins">
                Got questions or seeking more information? We're here to help!
                Complete the form, and our dedicated team will swiftly respond
                to your inquiries. Your curiosity matters to us, and we look
                forward to assisting you on your journey. Let's connect!
              </p>
            </div>
            </div>
            <div className="w-full md:w-1/2 p-[10px]">
      ...
      {/* Main Footer Content */}
      <div className="container ml-[105px] mr-[105px] w-[1140px] h-[430px]">
        <div className="grid grid-cols-[1fr_1fr_0.6fr_1fr] gap-6 text-gray-800">
          ...
          <div className="flex flex-col space-y-4 p-[10px]">
            <div className="flex items-center">
              <div className="elementor-widget-container">
                <img width="420" height="130" src="https://vismayee.com/wp-content/uploads/2023/11/Web-Logo-Trans.png" className="attachment-full size-full wp-image-922" alt="" srcset="https://vismayee.com/wp-content/uploads/2023/11/Web-Logo-Trans.png 420w, https://vismayee.com/wp-content/uploads/2023/11/Web-Logo-Trans-300x93.png 300w" sizes="(max-width: 420px) 100vw, 420px"/>
              </div>
              {/* <div className="ml-3">
            ...
            <p className="text-[#575757] text-sm mt-4 font-normal font-['Questrial'] text-justify">
              “Our vision is to revolutionize the world of education through innovative technology solutions. We aim to empower learners of all ages and backgrounds to access high-quality, personalized education, breaking down traditional barriers and fostering a lifelong love for learning. Our commitment is to create a global community of empowered, skilled, and adaptable individuals who are prepared to excel in an ever-evolving digital age. We envision a future where education knows no bounds, and every learner has the tools and resources they need to succeed.”
            </p>
         ...
         <div className="flex flex-col space-y-4 text-[14px] font-semibold leading-[24px] font-['Questrial']">
          ...
          <iframe loading="lazy" src="https://maps.google.com/maps?q=Sree%20Vismayee%20Edutek%20Pvt%20Ltd&amp;t=m&amp;z=15&amp;output=embed&amp;iwloc=near" title="Sree Vismayee Edutek Pvt Ltd" aria-label="Sree Vismayee Edutek Pvt Ltd"></iframe>
        </div>
          ...
          <div className="bg-gradient-to-r from-yellow-300 to-orange-400 p-6 rounded-3xl p-[20px] w-[279px] h-[391px]">
              ...
              <p className="text-black font-[Questrial] text-base font-normal">
                Subscribe now for exclusive updates, engaging content, and the latest insights!
                Join our community of learners and stay informed about exciting educational
                opportunities. Your journey to knowledge and discovery starts with a click.
              </p>
              <NewsletterForm />
          </div>
        </div>
